                        ...
                        <div>
                            ...
                            <div class="tm-comment tm-mb-45">
                                <figure class="tm-comment-figure">
                                    <img src="{{ asset('asset/img/comment-1.jpg') }}" alt="Image" class="mb-2 rounded-circle img-thumbnail">
                            ...
                            <div class="tm-comment-reply tm-mb-45">
                                ...
                                <div class="tm-comment">
                                    <figure class="tm-comment-figure">
                                        <img src="{{ asset('asset/img/comment-2.jpg') }}" alt="Image" class="mb-2 rounded-circle img-thumbnail">
                ...
                <aside class="col-lg-4 tm-aside-col">
                    <div class="tm-post-sidebar">
                        ...
                        <a href="#" class="d-block tm-mb-40">
                            <figure>
                                <img src="{{ asset('asset/img/img-02.jpg') }}" alt="Image" class="mb-3 img-fluid">
                                <figcaption class="tm-color-primary">Duis mollis diam nec ex viverra scelerisque a sit</figcaption>
                            </figure>
                        </a>
                        <a href="#" class="d-block tm-mb-40">
                            <figure>
                                <img src="{{ asset('asset/img/img-05.jpg') }}" alt="Image" class="mb-3 img-fluid">
                                <figcaption class="tm-color-primary">Integer quis lectus eget justo ullamcorper ullamcorper</figcaption>
                            </figure>
                        </a>
                        <a href="#" class="d-block tm-mb-40">
                            <figure>
                                <img src="{{ asset('asset/img/img-06.jpg') }}" alt="Image" class="mb-3 img-fluid">
