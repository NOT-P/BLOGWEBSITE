...
@section('content')
            ...
            <div class="row tm-row tm-mb-45">
                <div class="col-12">
                    ...
                    <img src="{{ asset('asset/img/about-01.jpg') }}" alt="Image" class="img-fluid">
                </div>
            </div>
            ...
            <div class="row tm-row tm-mb-60">
                ...
                <div class="col-lg-6 tm-mb-60 tm-person-col">
                    <div class="media tm-person">
                        <img src="{{ asset('asset/img/about-02.jpg') }}" alt="Image" class="img-fluid mr-4">
                ...
                <div class="col-lg-6 tm-mb-60 tm-person-col">
                    <div class="media tm-person">
                        <img src="{{ asset('asset/img/about-03.jpg') }}" alt="Image" class="img-fluid mr-4">
                        <div class="media-body">
                ...
                <div class="col-lg-6 tm-mb-60 tm-person-col">
                    <div class="media tm-person">
                        <img src="{{ asset('asset/img/about-04.jpg') }}" alt="Image" class="img-fluid mr-4">
                        <div class="media-body">
                ...
                <div class="col-lg-6 tm-mb-60 tm-person-col">
                    <div class="media tm-person">
                        <img src="{{ asset('asset/img/about-05.jpg') }}" alt="Image" class="img-fluid mr-4">
                        <div class="media-body">
