...
<!-- Search form -->
            ...
            <div class="row tm-row">
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.html" class="effect-lily tm-post-link tm-pt-60">
                        <div class="tm-post-link-inner">
                            <img src="{{ asset('asset/img/img-01.jpg') }}" alt="Image" class="img-fluid">                            
                        </div>
                ...
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.html" class="effect-lily tm-post-link tm-pt-60">
                        <div class=" tm-post-link-inner">
                            <img src="{{ asset('asset/img/img-02.jpg') }}" alt="Image" class="img-fluid">                            
                        </div>
                        <span class="position-absolute tm-new-badge">New</span>
                ...
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.html" class="effect-lily tm-post-link tm-pt-20">
                        <div class="tm-post-link-inner">
                            <img src="{{ asset('asset/img/img-03.jpg') }}" alt="Image" class="img-fluid">
                        </div>
                ...
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.html" class="effect-lily tm-post-link tm-pt-20">
                        <div class="tm-post-link-inner">
                            <img src="{{ asset('asset/img/img-04.jpg') }}" alt="Image" class="img-fluid">
                        </div>
                ...
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.html" class="effect-lily tm-post-link tm-pt-20">
                        <div class="tm-post-link-inner">
                            <img src="{{ asset('asset/img/img-05.jpg') }}" alt="Image" class="img-fluid">
                        </div>
                ...
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.html" class="effect-lily tm-post-link tm-pt-20">
                        <div class="tm-post-link-inner">
                            <img src="{{ asset('asset/img/img-06.jpg') }}" alt="Image" class="img-fluid">
                        </div>
